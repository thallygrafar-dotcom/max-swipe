...
export default function HomeLanding() {
  const carouselItems = [...fakeCards, ...fakeCards];
          ...
          <div className="mx-auto flex h-[78px] w-full max-w-[1320px] items-center justify-between px-4 sm:px-6">
            <Link to="/" className="group flex items-center gap-3">
              <div className="relative">
                ...
                <div className="relative flex h-10 w-10 items-center justify-center rounded-2xl border border-red-400/20 bg-red-600 font-bold text-white shadow-[0_12px_28px_rgba(239,68,68,0.34)]">
                  S
                </div>
              </div>
...
<section className="relative overflow-hidden py-6">
      ...
      <section id="beneficios" className="py-8 sm:py-12 xl:py-16">
        <div className="mx-auto w-full max-w-[1240px] px-4 sm:px-6">
          ...
          <div className="relative mx-auto mt-12 max-w-[1180px] sm:mt-14">
            ...
            <div className="relative overflow-hidden rounded-[28px] sm:rounded-[36px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-3 sm:p-4 shadow-[0_24px_70px_rgba(0,0,0,0.30)] backdrop-blur-2xl">
              ...
              <div className="relative grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                {previewItems.map((item, index) => (
                  <motion.div
                    ...
                    whileHover={{ y: -6 }}
                    className="group relative overflow-hidden rounded-[24px] sm:rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] p-[1px] shadow-[0_10px_30px_rgba(0,0,0,0.16)]"
                  >
                    <div className="relative h-full rounded-[23px] sm:rounded-[25px] bg-black/40 p-5 backdrop-blur-xl">
                      <div className="absolute inset-0 rounded-[23px] sm:rounded-[25px] bg-[radial-gradient(circle_at_top_left,rgba(239,68,68,0.08),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(255,255,255,0.02),transparent_30%)] opacity-80" />
      ...
      <section id="planos" className="py-8 sm:py-12 xl:py-16">
        <div className="mx-auto w-full max-w-[1240px] px-4 sm:px-6">
          ...
          <div className="mx-auto mt-12 grid max-w-[1020px] gap-6 lg:grid-cols-2 sm:mt-14">
            <PlanCard
              title="Mensal"
              price="R$ 147"
              subtitle="por mês"
      ...
      <footer className="border-t border-white/8 bg-black/40">
        <div className="mx-auto flex w-full max-w-[1240px] flex-col items-center justify-between gap-4 px-4 py-8 text-center sm:px-6 md:flex-row md:text-left">
          <div className="flex items-center gap-3">
            <div className="relative flex h-9 w-9 items-center justify-center rounded-2xl border border-red-400/20 bg-red-600 font-bold text-white shadow-[0_10px_24px_rgba(239,68,68,0.24)]">
              S
            </div>
...
function PlanCard({
  ...
  return (
    ...
    >
      <div
        className={[
          "relative h-full overflow-hidden rounded-[28px] sm:rounded-[32px] border p-6 sm:p-7 shadow-[0_18px_40px_rgba(0,0,0,0.22)] transition",
          featured
...
>
              ...
              <span
                className={[
                  "text-[15px] leading-7",
                  item.included ? "text-white" : "text-red-300/90",
                ].join(" ")}
              >
                {item.label}
              </span>
...
function BonusCard({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.45 }}
      whileHover={{ y: -6 }}
      className="group relative overflow-hidden rounded-[26px] sm:rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.018))] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.20)]"
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(239,68,68,0.08),transparent_34%)] opacity-80" />
      <div className="relative">
        <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-red-500/16 bg-red-500/10 text-red-300 shadow-[0_8px_24px_rgba(239,68,68,0.12)]">
          {icon}
        </div>
...
function GuaranteeSeal() {
  ...
  return (
    <motion.div
      ...
      className="relative flex h-[340px] w-[340px] items-center justify-center sm:h-[420px] sm:w-[420px] group"
    >
      {/* ROTAÇÃO PRINCIPAL */}
      <motion.div
      ...
      >
        {marks.map((_, i) => {
          ...
          return (
            ...
            >
              <div className="h-6 sm:h-8 w-[3px] rounded-full bg-red-500 opacity-90 group-hover:bg-red-400 transition-all duration-300" />
            </div>
          );
        })}
      </motion.div>
      ...
      {/* GLOW ANIMADO */}
      <motion.div
        className="absolute h-[160px] w-[160px] sm:h-[220px] sm:w-[220px] rounded-full bg-red-600/20 blur-[60px]"
      ...
      <motion.div
        ...
        className="relative flex h-[150px] w-[150px] sm:h-[190px] sm:w-[190px] items-center justify-center rounded-full bg-[#0a0a0a] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.04)]"
      >
        <div className="text-[90px] sm:text-[120px] font-extrabold leading-none tracking-[-0.08em] text-white">
          7
        </div>
      </motion.div>
    </motion.div>
...
function VslCard({
  ...
  return (
    <motion.article
      whileHover={{ y: -4 }}
      className="group relative w-[260px] sm:w-[310px] overflow-hidden rounded-[24px] sm:rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,24,0.96)_0%,rgba(10,10,14,0.98)_100%)] shadow-[0_16px_34px_rgba(0,0,0,0.22)]"
    >
      ...
      <div className="relative h-[170px] sm:h-[190px] overflow-hidden">
        ...
        <div className="absolute left-3 top-3 rounded-full border border-emerald-400/20 bg-emerald-400/[0.10] px-2.5 py-1 text-[10px] sm:text-[11px] font-semibold text-emerald-300 backdrop-blur">
          ● {status}
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <motion.div
            ...
            className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-red-600 text-white shadow-[0_16px_32px_rgba(239,68,68,0.30)]"
          >
      ...
      <div className="relative p-4">
        <h3 className="line-clamp-2 text-[16px] sm:text-[18px] font-semibold leading-[1.12] tracking-[-0.04em] text-white">
          {title}
        </h3>

        <p className="mt-3 text-[12px] sm:text-[13px] text-zinc-400">
          Nicho: <span className="text-zinc-200">{niche}</span>
        </p>

        <p className="mt-1 text-[12px] sm:text-[13px] text-zinc-400">
          Produto:{" "}
        ...
        <div className="mt-3 flex gap-2">
          <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[11px] sm:text-[12px] font-medium text-white/90">
            {style}
          </span>
          <span className="rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 text-[11px] sm:text-[12px] font-medium text-white/90">
            {format}
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <div className="flex h-[40px] sm:h-[44px] items-center justify-center rounded-[14px] sm:rounded-[16px] border border-red-500/30 bg-red-500/10 px-2 sm:px-3 text-[12px] sm:text-[13px] font-semibold text-white">
            Baixar VSL
          </div>
        ...
        <div className="mt-2 flex h-[40px] sm:h-[42px] items-center justify-center rounded-[14px] sm:rounded-[16px] border border-white/10 bg-white/[0.03] px-3 text-[12px] sm:text-[13px] font-medium text-zinc-200">
          Estrutura Invisível
        </div>
      </div>
    </motion.article>
